        ...
        private void tmrOcultarMenu_Tick(object sender, EventArgs e)
        {
            try
            {
                if (panLateral.Width <= 160)
                {
                    ...
                    btnMenuAtras.BackgroundImage = Properties.Resources.iconBackResized1;

                    btnMenuMatriculaEstudiante.BackgroundImageLayout = ImageLayout.Center;
                    btnMenuMatriculaEstudiante.BackgroundImage = Properties.Resources.iconAddEstudianteRedimensionado5;
                    ...
                    btnMenuCursosDisponibles.BackgroundImage = Properties.Resources.iconCursosResized1;

                    btnMenuIngresoNotas.BackgroundImageLayout = ImageLayout.Center;
                    btnMenuIngresoNotas.BackgroundImage = Properties.Resources.iconNotasResized1;
                    ...
                    btnMenuPersonal.BackgroundImage = Properties.Resources.iconPersonalResized1;
                }
                else
                {
